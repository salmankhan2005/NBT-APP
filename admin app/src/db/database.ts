        ...
        if (res.ok) {
          ...
          if (Array.isArray(apiVehicles)) {
            const mapped: ManagedVehicle[] = apiVehicles.map((v: any) => ({
              ...
              nationalPermitExpiryDate: v.national_permit_expiry_date || undefined,
              nationalPermitIssueDate: v.national_permit_issue_date || undefined,
              fiveYearPermitExpiryDate: v.five_year_permit_expiry_date || undefined,
              fiveYearPermitIssueDate: v.five_year_permit_issue_date || undefined,
              quarterTaxExpiryDate: v.quarter_tax_expiry_date || undefined,
              quarterTaxIssueDate: v.quarter_tax_issue_date || undefined,
              fcIssueDate: v.fc_issue_date || undefined,
              insuranceIssueDate: v.insurance_issue_date || undefined,
              pollutionIssueDate: v.pollution_issue_date || undefined,
